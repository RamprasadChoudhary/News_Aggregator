...
import EverythigCard from './EverythingCard';
...
function TopHeadlines() {
    ...
    useEffect(() => {
        ...
        fetch(`https://news-aggregator-backend-cglz.onrender.com/top-headlines?language=en${categoryParam}&page=${page}&pageSize=${pageSize}`)
        .then((response) => {
            if(response.ok) {
        ...
        .then((json) => {
            if(json.success){
                ...
                setError(json.message || 'An erro occured');
            }
        })
        .catch((error) => {
