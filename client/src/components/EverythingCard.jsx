...
function Card(props){
    return (
                ...
                <div className="info">
                    <div className="source-info flex items-center gap-2">
                        ...
                        <a
                            ...
                            >
                            {props.source && props.source.substring(0,70)}
                        </a>
                    </div>
        ...
        {/* added the new card content with style*/}

            <div className="flex lg:flex-row">
                <div className="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t-none lg:rounder-l text-center overflow-hidden"
                ...
                <div className="border rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                    <div className="mb-8">
                        <p className="text-sm text-grayd-600 flex items-center">
                            {props.memberIcon && (
                                <svg
                    ...
                    <div className="flex items-center">
                        {props.autherImage &&(
                            <img className="w-10 h-10 rounded-full mr-4"
                                src={props.autherImage}
                                alt="Avatar"
                            />
                        )}
                        <div className="text-sm">
                            <p className="text-gray-900">{props.autherName}</p>
